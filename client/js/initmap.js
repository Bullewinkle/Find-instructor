				...
				$.ajax({
					...
					success: function (res) {
						...
						for (var i = 0; i < instructorsList.length; i++) {
							...
							result += '<li class="main_user_link_container"> <a class="main_user_link" href="#/instructors/' + instructorsList[i]._id + '" data-userid="' + instructorsList[i]['_id'] + '">Страница инструктора</a> </li></ul></li>'
						}
						result += '</ul>'
